...
label ocobniak:
    ...
    if alinaIsAlive == False and arinaIsAlive:
        "???" "{i}Ирида, проходя мимо Дивана сильно толкает его плечом."
    elif alinaIsAlive and arinaIsAlive == False:
        "???" "{i}Эриван, проходя мимо Дивана сильно толкает его плечом."
    ...
    katia "..."
    "???" "{i} Диван замечает, что его компаньон Дьяволо засмотрелся на одно из величественных деревьев и совершенно не видит, что идет в неглубокую яму."
    
    menu:
        "{b}Предупредить Дьяволо?"
        "Да":
    ...
    scene bg ocobnak hole:
        zoom 1.7
    with fade
    "???" "{i}Открывая дверь, она издает очень пронзительный скрип, эхом пронесшийся по всему особняку."
    "???" "{i}Входя внутрь, героев встречает грязная, заросшая плесенью лестница."
    "???" "{i}Так же они услышали звуки фортепьяно"
    play sound "bethovin.mp3" fadein 1 
    ...
    divan "Хорошо, я пойду позади, помогу вам с арбалетом."
    if alinaIsAlive and arinaIsAlive:
        diana "Хорошо"
        ...
        nikita "Ква-ква-Ква"
        sergei "..."
    "???" "{i} Герои пошли на звук, он доносился из комнаты на первом этаже"
    "???" "{i} Подойдя к двери, за которой доносился звук, они чувствовали запах гнили и разлагающегося мяса"
    if alinaIsAlive:
    ...
    "???" "{i}Огромный мужчина, больше похожий на огра сидит и играет по клавишам фортепьяно чужими пальцами"
    ivan "БлЯтЬ, {w}ЭтО чТо ВоОбЩе ТаКоЕ???" with hpunch
    "???" "{i} Он, казалось, полностью погружен в музыку, он играючи создавал завораживающую мелодию. "
    "???" "{i} Огр почувствовав их присутствие, оборачивается и с ухмылкой говорит:"
    ...
    medved "О чем вы там шушукаетесь? Вы трое? Вас не устраивает мое гостеприимство?"
    "???" "{i} Тут же Ирида обратила его внимание на себя"
    diana "Что вы... Мы благодарим вас, за ваше гостеприимство!"
    ...
    "???" "{i} Авантюристы начали переглядываться и решать кто же даст правильный ответ"
    sergei "Я знаю, что это была за мелодия."
    sergei "Бетховен – к Элизе."
    ...
    "???" "{i} И тут Медвед указывает пальцем лишь на одного из всей команды и это оказывается...."
    ...
    menu:
        ...
        "TCP-соединение":
            pass
        "Ну штука такая типа нужная в инете":
            pass
    ...
    if countAnswer > 6:
        ...
        medved "Ох-ох-ох. Вы не достойны, чтобы я возвращал вашего друга!"
        $ sergeiIsAlive = False
    else:
    ...
    stop sound
    hide medved_2
    "???" "{i}За тем, странный мужчина исчезает и приоткрывается дверь в стене."
