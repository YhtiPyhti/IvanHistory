...
label forest:
    ...
    if alinaIsAlive and arinaIsAlive:
        alina "Спасибо, что спас меня и Кэрри. Не было возможности раньше поблагодорить. Если бы не ты..."
        arina "Да, если бы ты не помог нам, возможно мы бы уже были мертвы"
        divan "Так поступил бы каждый! Не стоит благодарить. Ладно я пойду спать, через несколко часов моясо Слиппи смена."
        arina "Спасибо!"
    elif arinaIsAlive:
        arina "Спасибо, что спас меня. Не было возможности раньше поблагодорить. Если бы не ты..."
        divan "Так поступил бы каждый! Не стоит благодарить. Ладно я пойду спать, через несколко часов моясо Слиппи смена."
        arina "Спасибо!"
    elif alinaIsAlive:
        alina "Спасибо, что спас меня. Не было возможности раньше поблагодорить. Если бы не ты..."
        divan "Так поступил бы каждый! Не стоит благодарить. Ладно я пойду спать, через несколко часов моясо Слиппи смена."
        alina "Спасибо!"
