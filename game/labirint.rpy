...
label labirint:
    ...
    $ questions = (
        ...
        Question(_('Любимы цвет Никиты Николаевича А.?'), 1, _('Розовый'), _('Вуксия'), _('Маджента'), _('Коралловый')),
        Question(_('Что сделал Никита Николаевич А., когда наступила осень?'), 3, _('Открыд входную дверь'), _('Напился'), _('Поджег сентябрь'), _('Перевернул календарь'))
    )
